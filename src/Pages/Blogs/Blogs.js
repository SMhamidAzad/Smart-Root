        ...
        <div className='container my-5'>
            ...
            <div className="row row-cols-1 row-cols-md-3 g-4">
                <div className="col">
                    <div className="card h-100 blog border-0 px-3 py-3">
                        <div className="card-body">
                            <h5 className="card-title mb-3"> Difference between authorization and authentication</h5>
                ...
                <div className="col">
                    <div className="card h-100 blog border-0 px-3 py-3">
                        <div className="card-body">
                            <h5 className="card-title mb-3">Why are you using firebase? What other options do you have to implement authentication?</h5>
                ...
                <div className="col">
                    <div className="card h-100 blog border-0 px-3 py-3">
                        <div className="card-body">
                            <h5 className="card-title mb-3">What other services does firebase provide other than authentication</h5>
